<template>
  <div class="clock" v-if="hourtime != ''">
    ...
    <div class="clock__hours">
      <span class="clock__hourtime" v-text="hourtime">{{tz}}</span>
      <span v-text="hours">{{tz}}</span>
    </div>
    <div class="clock__minutes" v-text="minutes">{{tz}}</div>
    <div class="clock__seconds" v-text="seconds">{{tz}}</div>
  </div>
</template>
